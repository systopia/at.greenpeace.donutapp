  ...
  private function getMockStack() {
    ...
    $mock = new MockHandler([
      new Response(
        ...
        str_replace('{ALT_CAMPAIGN}', $this->altCampaignId, self::DONATION_RESPONSE)
      ),
      new Response(
        200,
